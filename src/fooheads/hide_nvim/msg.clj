...
(s/def ::request-msg (s/cat :type ::request 
                            :msgid ::msgid 
                            :method ::method
                            :params ::params))

(s/def ::response-msg (s/cat :type ::response
                             :msgid ::msgid 
                             :error any?
                             :result ::result))

(s/def ::notification-msg (s/cat :type ::notification
                                 :method ::method
                                 :params ::params))

(s/def ::msg (s/or :request-msg ::request-msg
